...
class WilliamWallace:
    ...
    def __init__(self, iface):
        ...
        self.toolbar = self.iface.addToolBar(u'WilliamWallace')
        self.toolbar.setObjectName(u'WilliamWallace')
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/WilliamWallace/icon.png'
        self.add_action(
            icon_path,
            text = self.tr(u'Unused text'),
            callback = self.run,
